...
{
	public static final PropertyEnum<BlockBluestoneWire.EnumAttachPosition> NORTH = PropertyEnum.<BlockBluestoneWire.EnumAttachPosition>create("north", BlockBluestoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockBluestoneWire.EnumAttachPosition> EAST = PropertyEnum.<BlockBluestoneWire.EnumAttachPosition>create("east", BlockBluestoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockBluestoneWire.EnumAttachPosition> SOUTH = PropertyEnum.<BlockBluestoneWire.EnumAttachPosition>create("south", BlockBluestoneWire.EnumAttachPosition.class);
	public static final PropertyEnum<BlockBluestoneWire.EnumAttachPosition> WEST = PropertyEnum.<BlockBluestoneWire.EnumAttachPosition>create("west", BlockBluestoneWire.EnumAttachPosition.class);
	...
	public BlockBluestoneWire(String name) 
	{
		super(Material.CIRCUITS);
		this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockBluestoneWire.EnumAttachPosition.NONE).withProperty(EAST, BlockBluestoneWire.EnumAttachPosition.NONE).withProperty(SOUTH, BlockBluestoneWire.EnumAttachPosition.NONE).withProperty(WEST, BlockBluestoneWire.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockBluestoneWire.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockBluestoneWire.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockBluestoneWire.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockBluestoneWire.EnumAttachPosition.NONE;
	...
	private BlockBluestoneWire.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn, blockpos.down())))
        {
            ...
            if (!iblockstate1.isNormalCube())
            {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up()))
                {
                    ...
                    {
                        return BlockBluestoneWire.EnumAttachPosition.UP;
                    }
            ...
            return BlockBluestoneWire.EnumAttachPosition.NONE;
        }
        else
        {
            return BlockBluestoneWire.EnumAttachPosition.SIDE;
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        if (i != 0)
        {
            ...
            worldIn.spawnParticle(EnumParticleTypes.FALLING_DUST, d0, d1, d2, 0.5D, 0.0D, 0.8D, 22);
        }
    }
