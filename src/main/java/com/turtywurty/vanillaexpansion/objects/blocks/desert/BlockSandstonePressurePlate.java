...
public class BlockSandstonePressurePlate extends BlockBasePressurePlate
{
	public static final PropertyBool POWERED = PropertyBool.create("powered");
    private final BlockSandstonePressurePlate.Sensitivity sensitivity;

    public BlockSandstonePressurePlate(String name, BlockSandstonePressurePlate.Sensitivity sensitivityIn)
    {
        super(Material.ROCK);
