...
public class BlockBluestoneRepeater extends BlockBluestoneDiode
{
    ...
    public BlockBluestoneRepeater(String name, boolean powered)
    {
        super(name, powered);
    ...
    {
        return ((Integer)state.getValue(DELAY)).intValue() * 4;
    }
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return BlockInit.POWERED_BLUESTONE_REPEATER.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return BlockInit.UNLIT_BLUESTONE_REPEATER.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        if (this.isRepeaterPowered)
        {
            ...
            worldIn.spawnParticle(EnumParticleTypes.FALLING_DUST, d0 + d3, d1, d2 + d4, 0.0D, 0.0D, 0.0D, 22);
        }
    }
