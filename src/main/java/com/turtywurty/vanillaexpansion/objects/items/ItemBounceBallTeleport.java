...
public class ItemBounceBallTeleport extends Item
{
	public ItemBounceBallTeleport(String name) 
	{
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) 
    {
        ...
        if (!worldIn.isRemote)
        {
        	EntityBounceBallTeleport proj = new EntityBounceBallTeleport(worldIn, (EntityLivingBase)playerIn);
