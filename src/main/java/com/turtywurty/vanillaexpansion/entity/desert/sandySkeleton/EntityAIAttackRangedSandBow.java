...
public class EntityAIAttackRangedSandBow<T extends EntityMob & IRangedAttackMob> extends EntityAIBase
{
    ...
    public EntityAIAttackRangedSandBow(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_)
    {
    ...
    {
        return !this.entity.getHeldItemMainhand().isEmpty() && this.entity.getHeldItemMainhand().getItem() == ItemInit.SAND_BOW;
    }
        ...
        if (entitylivingbase != null)
        {
            ...
            if (this.entity.isHandActive())
            {
                ...
                else if (flag)
                {
                    ...
                    {
                        this.entity.resetActiveHand();
                        ((IRangedAttackMob)this.entity).attackEntityWithRangedAttack(entitylivingbase, ItemSandBow.getArrowVelocity(i));
