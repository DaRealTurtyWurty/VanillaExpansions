...
public class EntityBounceBallTeleport extends EntityThrowable
{
	private int hits = 0;
	public EntityBounceBallTeleport(World worldIn) 
	{
		super(worldIn);
	}

	public EntityBounceBallTeleport(World worldIn, EntityLivingBase throwerIn) 
	{
		super(worldIn, throwerIn);
	}

	public EntityBounceBallTeleport(World worldIn, double x, double y, double z) 
	{
		super(worldIn, x, y, z);
	}
